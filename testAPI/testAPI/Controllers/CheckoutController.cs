...
namespace testAPI.Controllers
{
    ...
    public class CheckoutController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet]
        [Route("UpdatePaymentAsyncTest")]
        public async Task<ActionResult<string>> UpdatePaymentAsyncTest([FromQuery] GreenPayResult payResult)
        {

            return "UpdatePaymentAsyncTest";
            //if (payResult == null || _context.ProductOrder == null || payResult.RtnCode != 1) return "付款失敗";
            //using var transaction = await _context.Database.BeginTransactionAsync();
            //try
            //{
